                ...
                <section class="sliderinfo">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="col-md-12">
                                    <section class="slider mainslider">
                                        <ul class="bxslider">
                                                <li>
                                                    <img src="assets/image/ministry_image.png" alt="Image" class="img-responsive imgback1">
                                                </li>
                                            <li>
                                            <img src="assets/image/ministry_image2.png" alt="Image" class="img-responsive imgback1">
                                            </li>
                                        </ul>
                                    </section>
                                </div>
                            ...
                            <ul id="ticker">
                                    <li><a  href="#" class="maininfo">{{$newsfirst->activity_name}}</a></li>
                                        <li><a  href="#" class="maininfo">{{$newssecond->activity_name}}</a></li>
                                            <li><a href="#" class="maininfo">{{$newsthird->activity_name}}</a></li>
                            </ul>
                                </div>
                                            ...
                                            @foreach ($data['rows'] as $dat )
                                             @if ($dat->status == 1)
                                                ...
                                                <div class="breifing">
                                                    ...
                                                    <a href="{{route('activity_details',['activity_name' => $dat->activity_name]) }}" >{!! html_entity_decode($dat->activity_name) !!} </a>
